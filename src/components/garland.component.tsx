            ...
            >
                ...
                <defs>
                    ...
                    >
                        ...
                        <feGaussianBlur
                            stdDeviation="3"
                            result="effect1_foregroundBlur_116_127907"
                        />
                    </filter>
                </defs>
            </svg>
            ...
            >
                ...
                <defs>
                    ...
                    >
                        ...
                        <feGaussianBlur
                            stdDeviation="3"
                            result="effect1_foregroundBlur_116_127912"
                        />
                    </filter>
                </defs>
            </svg>
            ...
            >
                ...
                <defs>
                    ...
                    >
                        ...
                        <feGaussianBlur
                            stdDeviation="3"
                            result="effect1_foregroundBlur_116_127917"
                        />
                    </filter>
                </defs>
            </svg>
            ...
            >
                ...
                <defs>
                    ...
                    >
                        ...
                        <feGaussianBlur
                            stdDeviation="3"
                            result="effect1_foregroundBlur_116_127922"
                        />
                    </filter>
                </defs>
            </svg>
            ...
            >
                ...
                <defs>
                    ...
                    >
                        ...
                        <feGaussianBlur
                            stdDeviation="3"
                            result="effect1_foregroundBlur_116_127927"
                        />
                    </filter>
                </defs>
            </svg>
...
export function Garland() {
    return (
        <div className={"top-0 left-0 w-full h-[120px] flex overflow-hidden absolute pointer-events-none z-100"} data-desc={"Garland component designed by VK (vk.com) (modified and recoded by Physgun)"}>
            <GarlandPart/>
            <GarlandPart/>
            <GarlandPart/>
            <GarlandPart/>
